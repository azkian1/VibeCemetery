...
const FAQ_ITEMS: FaqItem[] = [
  ...
  { question: 'How many graves do I get?', answer: 'Your GitHub account starts with 4 grave slots. Sharing your first grave unlocks 1 more, up to 5. GitHub and local projects share this allowance across both maps. When it is used, new burials are unavailable; existing graves stay.' },

...
- Auto-assigned user graves can use only `grave` and `grave_tall` slots in v1. `grave_special` is reserved for friends/welcome placements; Tier 2–3 slots are manual Gravedigger upgrades for best ideas.

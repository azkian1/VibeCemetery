      ...
      <StoneFrame isMobile={isMobile} maxWidth={560}>
        <div style={{ padding: isMobile ? '24px 20px' : '32px 36px', textAlign: 'center' }}>
          ...
          <p style={{ color: '#aaa9a0', lineHeight: 1.7, margin: '20px 0' }}>
            Give your coding agent <a href="https://vibecemetery.app" style={{ color: '#e8d5a3' }}>vibecemetery.app</a> and tell it which project you want to cremate. It will find the instructions and ask for your confirmation before publishing.
          </p>

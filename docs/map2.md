...
New graves receive a uniformly random free approved slot and a compatible persisted `grave_gid`. Placement stays fixed after creation. The account has 1 GitHub burial slot and 1 local AI-agent burial slot across maps. Sharing grants none.

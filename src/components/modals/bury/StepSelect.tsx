...
export default function StepSelect({ repos, selected, availableSlots, loading, onToggle, onNext, onBack }: {
  ...
  return <div>
    <p style={{ color: '#aaa9a0', fontSize: 13 }}>{loading ? 'Checking your grave allowance...' : availableSlots > 0 ? availableSlots + ' GitHub grave slot available.' : 'GitHub grave slot used. Your existing graves remain on the map.'}</p>

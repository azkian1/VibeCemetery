...
const FAQ_ITEMS: FaqItem[] = [
  ...
  { question: 'How many graves do I get?', answer: 'Your account has 1 GitHub project burial and 1 local AI-agent project burial. Each source has its own limit. Sharing a grave does not add a slot. Existing graves stay visible if you have already used an allowance.' },
